...
const ProductPage = () => {
    ...
    const getproductdatabyid = async () => {
        ...
        if (Item) {
            setimageset(Item[id-1])
            setproductdata(Item[id-1])
            setactiveimg(Item[id-1])
        }
    }

console.log('aaa3',activeimg, id)
                                ...
                                return (
                                    ...
                                    >
                                        <img src={item.image} alt=""
                                            className={
                                                activeimg[0].imgId == item.id ? 'active' : ''
                                            }
                                        />
                                    </div>
                                )
